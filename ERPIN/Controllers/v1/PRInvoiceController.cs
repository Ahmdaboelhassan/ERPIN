...
public class PRInvoiceController : ControllerBase
{
    private readonly IPRInvoiceService _invoiceService;

    public PRInvoiceController(IPRInvoiceService invoiceService)
    {
    ...
    [HttpPost("Create")]
    public async Task<IActionResult> Create(CreatePRInvoice model)
    {
    ...
    [HttpPut("Edit")]
    public async Task<IActionResult> Edit(CreatePRInvoice model)
    {
