...
public class PRReturnController : ControllerBase
{
    private readonly IPRReturnService _invoiceService;

    public PRReturnController(IPRReturnService invoiceService)
    {
    ...
    [HttpPost("Create")]
    public async Task<IActionResult> Create(CreatePRReturn model)
    {
    ...
    [HttpPut("Edit")]
    public async Task<IActionResult> Edit(CreatePRReturn model)
    {
