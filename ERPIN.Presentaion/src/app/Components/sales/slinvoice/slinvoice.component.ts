...
@Component({
  selector: 'app-slinvoice',
  imports: [DateRangeComponent, TranslatePipe, RouterLink],
  templateUrl: './slinvoice.component.html',
  styleUrl: './slinvoice.component.css',
})
export class SLInvoiceComponent {
  @ViewChild('tableRef', { static: true }) tableRef!: ElementRef;
  table!: Tabulator;

  constructor(
    private invocieService: SlInvoiceService,
    private router: Router,
    private translate: TranslateService,
    private title: Title
  ) {
    this.title.setTitle(translate.instant('SLInvoice.List'));
  }
  ...
  initTabulator(invoices: SLInvoiceResponse[]) {
